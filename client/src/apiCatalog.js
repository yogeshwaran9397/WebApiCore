...
export const catalog = [
  ...
  },
  {
    ...
    endpoints: [
      ...
      { id: 'patch', label: 'PATCH partial', method: 'PATCH', path: '/api/http-methods/:id', desc: 'Update only sent fields.', pathParams: [{ name: 'id', default: '1' }], body: { name: 'Patched Name', price: 19.99 } },
  ...
  },
  {
    ...
    blurb: 'The "real" domain API. Reads are public; create/update/delete require a token (login as admin).',
    endpoints: [
      { id: 'list', label: 'List (paged)', method: 'GET', path: '/api/books', desc: 'Pagination via query.', query: [{ name: 'page', default: '1' }, { name: 'pageSize', default: '5' }] },
      { id: 'get', label: 'Get by id', method: 'GET', path: '/api/books/:id', desc: 'Single book.', pathParams: [{ name: 'id', default: '1' }] },
